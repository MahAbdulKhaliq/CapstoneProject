...
namespace WorkoutRepository.Data.Migrations
{
    ...
    [Migration("20211110031812_ViewedExerciseDiscriminator")]
    partial class ViewedExerciseDiscriminator
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutRepository.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WorkoutRepository.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkoutRepository.Models.Exercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkoutRepository.Models.ExerciseStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ExerciseStats");
                });

            modelBuilder.Entity("WorkoutRepository.Models.FavouriteExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("FavouriteExercise");
                });

            modelBuilder.Entity("WorkoutRepository.Models.MuscleGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkoutRepository.Models.PrimaryEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PrimaryEquipment");
                });

            modelBuilder.Entity("WorkoutRepository.Models.Profile", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ProfileImageResource")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("ShowHealthMetrics")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WorkoutRepository.Models.UserStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkoutRepository.Models.UserWorkout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WorkoutRepository.Models.Reply", b =>
                {
                    b.HasBaseType("WorkoutRepository.Models.Comment");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WorkoutRepository.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WorkoutRepository.Models.Exercise", b =>
                {
                    b.HasOne("WorkoutRepository.Models.MuscleGroup", "MuscleGroup")
                        .WithMany()
